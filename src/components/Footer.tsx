export default function Footer() {
  return (
    <>
      <footer className="w-full px-6 lg:px-12 mb-2">
        <div className="bg-[#0025DB] text-white relative overflow-hidden rounded-[30px]">
      {/* Decorative dots pattern */}
      <div className="absolute left-1 top-75 opacity-40">
      ...
      <div className="absolute right-0 top-0 opacity-20">
        <svg width="200" height="400" viewBox="0 0 200 400">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                ...
                <span className="text-blue-200">info@yourdomain.com</span>
              </li>
              <li className="flex items-center gap-3">
                <svg
                  className="w-5 h-5 text-blue-200"
                ...
                <span className="text-blue-200">+7 (212) 654-33-35</span>
              </li>
            </ul>
          </div>
          ...
          {/* Office Address */}
          <div>
            <h3 className="text-xl font-bold mb-6">Office Addres</h3>
      ...
      <div className="fixed bottom-2 right-8 z-50 flex flex-col items-end gap-4">
        <button className="w-14 h-14 bg-[#0025DB] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow">
          <svg
